...
namespace Percolator.AnalysisServices.Linq
{
    ...
    public class Member : ICubeObject
    {
        ...
        /// </summary>
        public Member DataMember { get { return new Member(assembleExtension("DataMember")); } }
        /// <summary>
        /// Returns the hierarchy that contains a specified member, level, or hierarchy.
        /// </summary>
        public Set Dimension { get { return new Set(assembleExtension("Dimension")); } }
        /// <summary>
        /// Returns the first child of a specified member.
        /// </summary>
        public Member FirstChild { get { return new Member(assembleExtension("FirstChild")); } }
        /// <summary>
        ...
        /// </summary>
        public Member LastChild { get { return new Member(assembleExtension("LastChild")); } }
        /// <summary>
        /// Returns the last child of the parent of a specified member.
        /// </summary>
        public Member LastSibling { get { return new Member(assembleExtension("LastSibling")); } }
        /// <summary>
        /// Returns the hierarchy that contains a specified member or level.
        /// </summary>
        public Set Hierarchy { get { return new Set(assembleExtension("Hierarchy")); } }
        /// <summary>
        /// Returns the name of a dimension, hierarchy, level, or member.
        /// </summary>
        public Member Name { get { return new Member(assembleExtension("Name")); } }
        /// <summary>
        /// Returns the parent of a member.
        /// </summary>
        public Member Parent { get { return new Member(assembleExtension("Parent")); } }
        /// <summary>
        /// Returns the next member in the level that contains a specified member.
        /// </summary>
        public Member NextMember { get { return new Member(assembleExtension("NextMember")); } }
        /// <summary>
        /// Returns the previous member in the level that contains a specified member.
        /// </summary>
        public Member PrevMember { get { return new Member(assembleExtension("PrevMember")); } }
        /// <summary>
        /// Returns the siblings of a specified member, including the member itself.
        /// </summary>
        public Set Siblings { get { return new Set(assembleExtension("Siblings")); } }
        /// <summary>
        /// Returns the unique name of a specified dimension, hierarchy, level, or member.
        /// </summary>
        public Member UniqueName { get { return new Member(assembleExtension("UniqueName")); } }
        /// <summary>
        ...
        /// </summary>
        public Member Value { get { return new Member(assembleExtension("Value")); } }
        /// <summary>
        /// Returns the current member's caption.
        /// </summary>
        public Member Member_Caption { get { return new Member(assembleExtension("Member_Caption")); } }
        /// <summary>
        ...
        /// <returns></returns>
        public Member Item(int itemNumber) { return new Member(string.Format("{0}.Item({1})", assembleMember(), itemNumber)); }
        /// <summary>
        ...
        /// <returns></returns>
        public Member Lead(int leadCount) { return new Member(string.Format("{0}.Lead({1})", assembleMember(), leadCount)); }
        /// <summary>
        ...
        /// <returns></returns>
        public Member Lag(int lagCount) { return new Member(string.Format("{0}.Lag({1})", assembleMember(), lagCount)); }
        /// <summary>
        /// MDX 'Properties' function. Returns the property from the Member Properties list.
        /// </summary>
        /// <param name="property"></param>
        /// <returns></returns>
        public Member Properties(string property) { return new Member(String.Format("{0}.Properties(\"{1}\")", assembleMember(), property)); }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public override string ToString() { return assembleMember(); }
        ...
        {
            return string.Format("{0}.{1}", assembleMember(), str);
        }
    }
}
